	...
	<div class="container">
		<div class="row">
			<div class="col l6 m12 s12 right-align" data-aos='flip-left' data-aos-duration='1000' style="margin-top: 8px;">
				...
				<img src="images/collection/black-edition.png" class="responsive-img">
				<div class="row">
			...
			<div class="col l6 s12 m12 white-text" data-aos='flip-right' data-aos-duration='1000' style="margin-top: 59px;">
				<?php echo'<h6>'. $records->description.'</h6>'; ?>
				<p><strong> Includes:</strong></p>
				<ul class="desc" style="margin-top: 33px; margin-right: 30px">
					<li> amet commodo rutrum. Id justo eget massa ma</li>
					<li> amet commodo rutrum. Id justo eget massa ma</li>
					<li> amet commodo rutrum. Id justo eget massa ma</li>
					<li> amet commodo rutrum. Id justo eget massa ma</li>
					<li> amet commodo rutrum. Id justo eget massa ma</li>
				...
				<div class="card" style="background-color:transparent;margin-top: 51px;">
					...
					<div style="margin-top:19px"><a href="custom_collection_page.php" class="webShpBtn center" style="width:198px;height:40px;border-radius:0px"> 
											 Select a plan</a></div>
      ...
      <div class="card" style="background:transparent;">
        <div class="card-content white-text">
          <div class="card-title left-align" style="margin-bottom:30px">
          	<a href="#" class="webShpBtn center"> Description</a>
          	<a href="<?php if (isset($_SESSION['email'])) {
                      echo 'product_page_review.php?id=1';}else{echo 'login.php';}?>"class="webShpBtn center" style="background-color:transparent;">Reviews</a>
          </div>
          <p class="left-align">
          	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consectetur amet faucibus amet commodo rutrum. Id justo eget massa massa lorem aliquam magna sem. Facilisi consectetur sit viverra elit sit purus faucibus. Turpis vitae tempus ac sagittis tellus pulvinar enim. Etiam in mattis at rhoncus risus.
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consectetur amet faucibus amet commodo rutrum. Id justo eget massa massa lorem aliquam magna sem. Facilisi consectetur sit viverra elit sit purus faucibus. Turpis vitae tempus ac sagittis tellus pulvinar enim. Etiam in mattis at rhoncus risus.
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consectetur amet faucibus amet commodo rutrum. Id justo eget massa massa lorem aliquam magna sem. Facilisi consectetur sit viverra elit sit purus faucibus. Turpis vitae tempus ac sagittis tellus pulvinar enim. Etiam in mattis at rhoncus risus.
			</p>
        </div>
