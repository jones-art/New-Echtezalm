...
<div class="container">
		...
		<div class="col l3 s12 m6">
			<h4 style="font-family:playfair" class="text-white font-weight-bold left-align">Verbind je met ons</h4>
			<img src="images/icon/arrow-right.png">
		</div>
		<div class="col l3 s12 m6">
		<h4 style="font-family:playfair" class="text-white font-weight-bold left-align">Sitemap</h4>
    <div>
	...
	<div class="col l3 s12 m6">
			<h4 style="font-family:playfair;text-align:left;" class="text-white font-weight-bold">Blog</h4>
			<p class="text-muted">Lancering van nieuwe website</p>
		</div>
	<div class="col l3 s12 m6">
			<h4 style="font-family:playfair" class="text-white left-align font-weight-bold">Social media</h4>
			<div>
