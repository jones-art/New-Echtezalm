...
if (isset($_SESSION['id'])) {
  ...
  $id = $_SESSION['id'];
        ...
        $getOrder = $connect2db->prepare("SELECT count(order_id) AS prod_count , order_id FROM tbl_order WHERE user_id = ? AND payment_status = ? GROUP BY id");
...
//     echo "<script> alert('Unfinished'); </script>";
        ...
        <div class=" center" style="text-align:center;align-content: center;">
          <div class="row center">
            <div class="col s12 "><h5>Your Shopping Carts <?php echo $num;?></h5></div>
