      ...
      <div class="card" style="background:transparent;">
        <div class="card-content white-text">
          <div class="card-title left-align" style="margin-bottom:30px">
          	<a href="collection_page_description.php?id=<?php echo $encId;?>" class="webShpBtn center" > Description</a>
          	<a href="<?php if (isset($_SESSION['email'])) {
                      echo 'collection_page_review.php?id='.$encId;}else{echo 'login.php';}?>"class="webShpBtn center" style="background-color:transparent;">Reviews</a>
          </div>
          	...
          	<?php 
                ...
                if($getReview->rowcount()>0){
                 ...
                 <?php   }
                    ...
                    <div>Collection Not Yet Reviewed</div>
               <?php }
            ?>
			</p>
        </div>
