...
<html>
  ...
  <!-- Include favicon -->
    <link rel="icon" type="images/png" href="images/icon/favicon.png">
...
<!-- Big Nav Head -->
<nav class="d-flex">
    <div class="nav-wrapper cart-nav">
      <a href="#" data-target="mobile-demo" class="sidenav-trigger" ><img src="images/icon/menu.png"></a>
      <a href="index.php" class="brand-logo center"><img src="images/logo-white.png" class="responsive-img" style="margin:0px;padding:0px"></a>
      
          <a href="cart.php" class="right" style="padding-right:0px;margin-right:0px%;">
            <img src="images/cart.png" style="padding-right:0px;margin-right:0px;">
            <button style=" 
                  position: relative;
                  top: -25px;
                  right: 6px;
    ...
    <div class="nav-wrapper menu container-fluid ">
      <ul class="" id="menu">
        ...
        <li class="dropdown white-text">
          <a class="dropdown-trigger" href="#!" data-target="accounts">
  ...
  <ul class="sidenav" id="mobile-demo" style="background:black;color:white;">
    <li><a class="<?php $page=='home'?print'active':print'';?> white-text" id="home" href="index.php">Home </a></li>
    <li><a href="webshop.php" class="<?php $page=='webshop'?print'active':print'';?> white-text">Web Shop</a></li>
    <li><a href="aboutUs.php" class="<?php $page=='about'?print'active':print'';?> white-text">About Us</a></li>
    <li><a href="blog.php" class="<?php $page=='blog'?print'active':print'';?> white-text">Blog</a></li>
    <li><a href="contact.php" class="<?php $page=='contact'?print'active':print'';?> white-text">Contact</a></li>
       <li class="dropdown">
          <a class="dropdown-trigger white-text" href="#!" data-target="account">
           <?php if (isset($_SESSION['email'])) {
             echo($_SESSION['email']);
           } else{
            echo "My Account";
...
<ul id="account" class="dropdown-content right" style="background: black;padding-top:0px;margin-top:0px">
  <?php 
    if (isset($_SESSION['email']) && isset($_SESSION['email']) !='') {
     echo ' <li ><a class="" href="profile.php" style="color: white">My Account</a></li>
            <li ><a class="" href="myOrder.php" style="color: white">My Order</a></li>
            <li ><a class="" href="profile-subscription.php" style="color: white">My Suscription</a></li>
  ...
  ?>
   ...
   <ul id="accounts" class="dropdown-content" style="background: black;padding-top:0px;margin-top:0px;display:block;">
  <?php 
    if (isset($_SESSION['email']) && isset($_SESSION['email']) !='') {
     echo ' 
     <li ><a class="" href="profile.php" style="color: white">My Account</a></li>
            <li ><a class="" href="myOrder.php" style="color: white">My Order</a></li>
            <li ><a class="" href="profile-subscription.php" style="color: white">My Suscription</a></li>
            <li ><a class="" href="logout.php" style="color: white">Logout</a></li>';
      }
