       ...
       <div class="row">
         ...
         <div class="col-sm-6">
          <div class="card" style="background:transparent;">
            <div class="card-body">
               <h5 class="text-white mb-4"> <?php echo $row->blog_title; ?> </h5>
               <div class="row mb-3">
                 <div class="col-sm-8">
               ...
               <div class="accordian text-white" style="border: 1px solid #fff;border-radius:5px;padding:10px">
                <img src="blog/<?php echo $row->image;?>" style="width:85%;height:350px">
                 <p class="text-white <?php if(isset($_GET['rid']) && $_GET['rid'] != ''){echo "";}else{echo 'text-truncate';} ?>"> <?php echo $row->content;?> </p>
