...
if(isset($_GET['eid']) && $_GET['eid'] != ''){
    ...
    $p_image2 = 'product/'.$row->image2;
    $p_image3 = 'product/'.$row->image3;
    $p_image4 = 'product/'.$row->image4;
			     ...
			     <div class="card-body">
	              ...
	              <?php }?>
					...
					<div class="form-group row">
					  ...
					  <div class="col-sm-3">
						<input type="number" name="quantity" class="form-control custom-input" id="quantity" value="<?php if(isset($_GET['eid']) && $_GET['eid'] != ''){echo$p_quantity;} ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
					  </div>
					</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <label for="file1" class="span">
					  	<img id="slidOne" src="<?php if(isset($_GET['eid']) && $_GET['eid'] != ''){echo $p_image2;}else{echo$img_src;} ?>" style="width:50px;height:50px;">
					  </label>
                      <div class="col-sm-10">
                    ...
                    <div class="col-sm-3">
                      <label for="file2" class="span">
					  	<img id="slidTwo" src="<?php if(isset($_GET['eid']) && $_GET['eid'] != ''){echo $p_image3;}else{echo$img_src;} ?>" style="width:50px;height:50px;">
					  </label>
                      <div class="col-sm-10">
                    ...
                    <div class="col-sm-3">
                      <label for="file3" class="span">
					  	<img id="slidThree" src="<?php if(isset($_GET['eid']) && $_GET['eid'] != ''){echo $p_image4;}else{echo$img_src;} ?>" style="width:50px;height:50px;">
					  </label>
                      <div class="col-sm-10">
