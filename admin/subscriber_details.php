        	...
        	<div class="col-xl-6">
        		<div class="card bg-transparent">
        			...
        			<div class="row">
				        ...
				        <div class="col-sm-12">
				        	<p style="color:#7CF094;font-size:20px;text-align:center;background:#3A3A3A;height:51px;padding-top:13px;font-weight:500px;letter-spacing:0.05em">  <?php if($status == 'Expired') {echo '<span style="color:red">'.$status.'</span>';} else if($status == 'Cancelled') {echo '<span style="color:red">'.$status.'</span>';}else{echo 'Next Delivery'. $nxtDelv;} ?> </p>
				        </div>
