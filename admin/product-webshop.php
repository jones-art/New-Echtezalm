              ...
              <div class="table-responsive">
                ...
                <tbody>
                    <?php 
                        ...
                        $product = $connect2db->prepare("SELECT * FROM product ");
                        ...
                        while ($row = $product->fetch()) {
                            ...
                            <tr class="mt-3 mb-3" style="background: #3A3A3A;">
                                ...
                                <td><img src="product/<?php echo $row->image ?>" height="53px" width="53px"></td>
                                <td><?php echo $i; ?></td>
                                ...
                                <td><a href="add-product.php?eid=<?php echo($row->id);?>" style="color:#DAC08E;">Edit</a></td>
                            </tr>
                        <?php
                        $i=$i+1;
                        }
