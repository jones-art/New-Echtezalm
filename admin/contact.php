...
<section>
	<div class="container">
		<div class="row">
			<div class="col m3 s12 card black white-text">
				<div class="row">
        ...
        <div class="row">
          ...
          <div class="col s10" style="padding-top: 56px;">
            ...
            <div class="col m3 s12 card black white-text">
				<div class="row">
					<div class="col s2 black" style="padding-top: 24px;">
            <img src="images/icon/ideal-contact.png">      
          </div>
          
          <div class="col s10" style="padding-top: 56px;">
            <p style="color: #DAC08E;">Ideal payment system</p>
            <p style="margin-top: 10px;">Echte Zalm - AmbiSmart Enterprise<br>
KvK: 74981536<br>
BTW: NL19.87.4.9.488.B03</p>
          </div>
				</div>
			</div>
